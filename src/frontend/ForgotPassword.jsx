    ...
    return(
        <div ref={ref} onAnimationEnd={onAnimationEnd} className={`flex ${animate} items-center justify-center bg-white shadow-md w-100 h-100 rounded-2xl`}>
            <div className="text-[#830FAD] text-center  text-3xl">
                ...
                <p className="text-xs text-center text-black w-70 poppins-regular">Enter your email below to receive password reset instructions</p>
                <form onSubmit={handleSendEmail} action="" className="flex flex-col gap-5 text-sm mt-15 text-start w-70 poppins-regular">
                     <div className="w-full text-black" >
                        <label className="text-start" htmlFor="">Email</label><br />
                        <input value={email} required onChange={(e)=> setEmail(e.target.value)} type="email" className="w-full border-b mt-2 focus:outline-none border-[#0000004d]" placeholder="Enter Your Email" />
                    </div>
                     <div className="w-full text-black" >
                         <button
                            type="submit"
                        ...
                        <p className="mt-3 text-xs text-center">Didn't get the code?<span className="text-[#754BA1] cursor-pointer "> Resend</span></p>
                    </div>
