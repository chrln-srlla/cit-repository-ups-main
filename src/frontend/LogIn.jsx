                ...
                <header className="fixed inset-x-0 top-0 z-20 bg-white/0 ">
                    <nav className="grid items-center h-12 grid-cols-3 px-6 mx-auto max-w-7xl md:h-22">
                        ...
                        <div className="flex items-center justify-end w-full col-start-3 ml-auto md:flex">
                            <Link to="/signup" className="flex items-center justify-center h-9 px-8 border cursor-pointer bg-white poppins-medium border-[#754BA1] text-sm font-semibold rounded-full hover:bg-purple-50 transition-colors">Sign Up</Link>
                        </div>
                    </nav>
                </header>
